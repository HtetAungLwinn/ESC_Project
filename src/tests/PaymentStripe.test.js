...
test('renders guest details table with correct values', async () => {
  await act(async () => {
    render(
      <MemoryRouter initialEntries={['/payment?destination_name=CityX&hotel=HotelY&hotel_addr=456%20Avenue&checkin=2025-12-01&checkout=2025-12-05&adults=3&children=2&price=500']}>
...
// TODO: mock Stripe, check for Stripe success/failure
